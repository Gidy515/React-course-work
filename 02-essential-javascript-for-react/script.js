...
const book = getBook(1); // this book variable grabs the whole object of the book with id 1, which is "The Cyberiad"
...
const { title, author, pages, publicationDate, genres, hasMovieAdaptation } =
  book; // this is the destructuring assignment syntax, it allows us to extract multiple properties from an object and assign them to variables in a single statement. In this case, we are extracting the title author, pages, and other properties from the book object and assigning them to variables with the same name.
title;
author;
genres;
...
}`; // this will create a summary string that includes the title, author, and publication date of the book. The ${} syntax allows us to insert the variables into the string.
